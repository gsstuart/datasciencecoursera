...
Column `pdate` is added to provide the event date in a POSIX-compliant format, and the range of dates covered in the input file is calculated for inclusion in plots.
