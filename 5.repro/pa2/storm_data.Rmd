...
```{r plot1, fig.width=14, fig.height=7, cache=TRUE}
...
suppressWarnings(grid.arrange(plot_fatalities, plot_injuries, ncol = 2, 
                main=textGrob(paste0("\nTop 10 Fatality and Injury-Causing Storm Events in the United States, ", pdate_range_str),gp=gpar(fontsize=24))))
```
*Figure 1.* 
<br/>
...
```{r plot2, fig.width=14, fig.height=7, cache=TRUE}
...
suppressWarnings(grid.arrange(plot_prop_dmg, plot_crop_dmg, ncol = 2, 
                 main=textGrob(paste0("\nTop 10 Property and Crop-Damaging Storm Events in the United States, ", pdate_range_str),gp=gpar(fontsize=24))))
```
*Figure 2.*

<br/><br/><br/>
<table width=100%><tr><td align="right">
<img src="http://us.cdn3.123rf.com/168nwm/isselee/isselee1207/isselee120700179/14276909-european-herring-gull-larus-argentatus-4-years-old-standing-against-white-background.jpg"/>
</td></tr</table>
